...
import { FaJava, FaJs, FaPython, FaHtml5, FaCss3Alt, FaReact, FaNodeJs, FaAngular, FaAws, FaGitAlt, FaDocker, FaJira, FaConfluence, FaSwift, FaBrain, FaEye } from "react-icons/fa";
import { SiTypescript, SiCplusplus, SiSpringboot, SiNextdotjs, SiExpress, SiTailwindcss, SiMysql, SiMongodb, SiPostgresql, SiFirebase, SiGooglecloud, SiKubernetes, SiJenkins, SiPostman, SiApachespark, SiApachekafka, SiJupyter, SiTableau, SiPowerbi, SiPrometheus, SiTensorflow } from "react-icons/si";
...
const skills = {
  ...
  row2: [
    ...
    { title: "Apache Spark", icon: SiApachespark, color: "#D24939" },
  ...
  row4: [
    ...
    { title: "Power BI", icon: SiPowerbi, color: "#F2C811" },
    { title: "TensorFlow", icon: SiTensorflow, color: "#FF6F00" },
    { title: "CNN", icon: FaBrain, color: "#FF6B6B" },
    { title: "Computer Vision", icon: FaEye, color: "#4ECDC4" },
    { title: "Postman", icon: SiPostman, color: "#FF6C37" },
    { title: "Prometheus", icon: SiPrometheus, color: "#E6522C" },
  ],
};
