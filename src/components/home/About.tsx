        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
              <motion.div
                className="relative w-[500px] h-[500px] bg-white overflow-hidden"
                animate={{
                  borderRadius: [
          ...
          >
            ...
            >
              I&apos;m a passionate Data Scientist with a Master's degree in Data Science from Arizona State University, specializing in data analytics, machine learning, and real-time data solutions. I enjoy transforming complex data into meaningful insights that drive informed decisions and help solve real-world problems.
            </motion.p>
