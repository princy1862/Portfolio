...
<motion.div 
      ...
      >
        ...
        From patterns to predictions, I turn data into decisions with precision.
        </p>
        ...
        <div className="flex justify-center gap-6">
          <motion.a
            href="https://github.com/princy1862"
            target="_blank"
          ...
          <motion.a
            href="https://www.linkedin.com/in/princy-patel-a8a056215/"
            target="_blank"
            rel="noopener noreferrer"
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.9 }}
